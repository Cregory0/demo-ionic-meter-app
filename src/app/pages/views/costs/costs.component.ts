...
export class CostsComponent implements OnInit {
  // Energy tariff in pennys 35.056 = 0.35p
  public energyRate: any = 35.056;
  public standingChargeRate: any = 38.936;
  ...
  renderData() {
    ...
    this.dayRateCalc(this.standingChargeRate);
    this.updateEnergy(this.reading[0].reading, this.reading[1].reading);
    this.energyCalc(this.energyRate, this.energyUsage);
